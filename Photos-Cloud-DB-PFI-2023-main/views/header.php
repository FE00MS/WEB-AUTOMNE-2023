...
if (strcmp($viewName, "photoList") == 0) {
    ...
    if ($sortType == "keywords") {
        $viewHeadCustom = <<<HTML
           <div class="searchContainer">
                <input type="search" class="form-control" placeholder="Recherche par mots-clés" id="keywords" value= "$valueKeyword" />
